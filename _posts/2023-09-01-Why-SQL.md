...
![CRUD Operations Photo Courtesy of https://static.javatpoint.com/sqlpages/images/crud-operations-in-sql1.jpg]({{ site.baseurl }}/images/2023-09-01-Why-SQL-Pictures/crud-operations-in-sql.jpg)
...
{% include info.html text="These keywords are not case sensitive, rather are capitalized to emphasize that they are keywords. For the entirety of this blog post, I will be capitalizing any and all keywords used in my queries to emphasize this, as I haven't included all keywords above." %}
...
{% include info.html text="There are no Boolean values in SQLite however by using the integers 0 and 1 in tables we can keep track of Boolean values when we use python to interpret the data." %}
...
![Sample SQLite3 Terminal]({{ site.baseurl }}/images/2023-09-01-Why-SQL-Pictures/sample-sqlite-terminal-output.png)
...
![Proper Windows SQLite Binaries]({{ site.baseurl }}/images/2023-09-01-Why-SQL-Pictures/sqlite-downloads-windows.png)
...
![Environment Variables Button]({{ site.baseurl }}/images/2023-09-01-Why-SQL-Pictures/environment-variables-button.png)

2) Under system variables double click the variable named Path

![Path Variable]({{ site.baseurl }}/images/2023-09-01-Why-SQL-Pictures/path-variable.png)
...
![Motivating Example Single Large Table]({{ site.baseurl }}/images/2023-09-01-Why-SQL-Pictures/motivating-example-large-table.png)
...
![Generated Employees Table]({{ site.baseurl }}/images/2023-09-01-Why-SQL-Pictures/employees-table.png)
...
![Generated Customer Table]({{ site.baseurl }}/images/2023-09-01-Why-SQL-Pictures/customers-table.png)
...
![Generated Products Table]({{ site.baseurl }}/images/2023-09-01-Why-SQL-Pictures/products-table.png)
...
![Generated Serialization Table]({{ site.baseurl }}/images/2023-09-01-Why-SQL-Pictures/serialization-table.png)
...
![Successful Transaction Output]({{ site.baseurl }}/images/2023-09-01-Why-SQL-Pictures/successful-transaction-terminal-output.png)
...
![Transaction Table Post Sale]({{ site.baseurl }}/images/2023-09-01-Why-SQL-Pictures/transactions-table-post-sale.png)
...
![Proving Correct Customer]({{ site.baseurl }}/images/2023-09-01-Why-SQL-Pictures/proving-correct-customer.png)

And to check if the bike is registered as sold we can query the serialization table as follows:

![Checking if Bike Sold]({{ site.baseurl }}/images/2023-09-01-Why-SQL-Pictures/checking-if-bike-sold.png)
